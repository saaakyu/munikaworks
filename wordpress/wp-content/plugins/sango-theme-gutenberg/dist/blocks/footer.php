...
register_block_type('sgb/footer', array(
  'editor_script' => 'sgb',
  'attributes' => array(
    'bgColor' => array(
      'type' => 'string',
  ...
  'render_callback' => function ($attributes, $content) {
    ...
    if (!is_admin() && !defined('REST_REQUEST') && $show_rich_footer) {
      $html =  "
        <footer class=\"sgb-footer\" style=\"background-color: {$bg_color};\">
          <div class=\"sgb-footer__content\" style=\"max-width: {$content_width}px;\">
            {$content}
          </div>
          __replace_here__
        </footer>
    ...
    ob_start();
    ?>
    <div class="sgb-footer__menu" style="<?php echo $style ?>">
      <div>
        <a class="sgb-footer__menu-btn" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php fa_tag("home","home",false) ?> HOME</a>
      </div>
      <nav>
