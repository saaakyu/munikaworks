...
class Editor
{
  public function init() {
    add_action( 'enqueue_block_assets', [$this, 'load_editor_asset']);
    add_action( 'enqueue_block_editor_assets', [$this, 'setup_editor_asset']);
    add_filter( 'admin_body_class', [$this, 'add_fontawesome_class_to_body']);
