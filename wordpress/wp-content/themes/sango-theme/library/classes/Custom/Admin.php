...
class Admin extends Custom
{
    public function init()
    {
        ...
        add_action('admin_print_styles', [$this, 'admin_custom_assets']);
        add_action('admin_menu', [$this, 'admin_settings']);
        add_action( "manage_posts_custom_column", [$this, 'manage_custom_column'], 10, 2 );
        add_action( "manage_pages_custom_column", [$this, 'manage_custom_column'], 10, 2 );
        add_action( 'admin_head-edit.php', [$this, 'admin_head_edit'], 100 );
    ...
    {
        add_menu_page('SANGO 設定', 'SANGO 設定', 'manage_options', 'sng_admin_settings', [$this, 'print_custom_page'], get_template_directory_uri().'/library/images/logo-sidebar.png', 20);
