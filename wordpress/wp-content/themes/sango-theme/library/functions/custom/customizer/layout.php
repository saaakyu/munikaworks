...
App::get('customizer_builder')->addSection('✨ デザイン・レイアウト', 'desing_layout_setting', [
  'priority' => 52
]);
App::get('customizer_builder')->addSection('全体レイアウト', 'all_layout', [
  'priority' => 1,
  'parent' => 'desing_layout_setting'
]);
App::get('customizer_builder')->addConfig('all_layout', [
...
App::get('customizer_builder')->addSection('記事一覧レイアウト', 'card_layout', [
  'priority' => 2,
  'parent' => 'desing_layout_setting'
]);

App::get('customizer_builder')->addConfig('card_layout', [
...
App::get('customizer_builder')->addSection('記事コンテンツ', 'sng_entry', [
  'priority' => 3,
  'parent' => 'desing_layout_setting'
]);
App::get('customizer_builder')->addConfig('sng_entry', [
  'name' => 'no_eyecatch',
  'updateMethod' => 'option',
  'transport' => 'postMessage',
...
App::get('customizer_builder')->addSection('フォントサイズ', 'font_size_setting', [
  'priority' => 4,
  'parent' => 'desing_layout_setting'
]);
App::get('customizer_builder')->addConfig('font_size_setting', [
  'name' => 'mb_font_size',
  'updateMethod' => 'option',
  'default' => '100',
  'title' => 'スマホでのフォントサイズ',
...
App::get('customizer_builder')->addSection('フォント種類', 'font_family_setting', [
  'priority' => 5,
  'parent' => 'desing_layout_setting'
]);
App::get('customizer_builder')->addConfig('font_family_setting', [
...
App::get('customizer_builder')->addSection('サイドバー', 'sng_sidebar_widget', [
  'priority' => 6,
  'parent' => 'desing_layout_setting'
]);
App::get('customizer_builder')->addConfig('sng_sidebar_widget', [
...
App::get('customizer_builder')->addSection('コンテンツブロック', 'sng_content_block', [
  'priority' => 7,
  'parent' => 'desing_layout_setting'
]);
...
App::get('customizer_builder')->addConfig('sng_content_block', [
