	...
	<div id="munika_page">
		...
		<li property="itemListElement" typeof="ListItem">
			...
			<div class="wrp_intro">
				<div class="con_intro">
					<div class="box_intro">
						<p class="tmp_txt">創作活動に関するロゴ制作・同人誌表紙デザインなどを承っております。<br>
					...
					<div class="con_flow">
						...
						<div class="box_flow">
							...
							<div class="box_flow__desc">
								...
								<p class="box_flow__copy">メールにてご依頼の内容のヒアリングを行います。<br>制作物、大まかな方向性やスケジュールなどがすべて確定した後、お見積り金額をお送りいたします。<br><span class="small">※納期マストのご依頼は修正対応やクオリティの保証が難しくなるため、期限に余裕を持ってのご相談をお願いいたします。</span></p>
							</div>
						</div>
		...
		<div class="wrp_list">
			...
			<div class="con_list_col2">
				...
				<div class="box_list">
					...
					<p class="tmp_txt">1案に絞った後、やっぱり違うデザインにしたい、など大幅な修正が入った場合は追加料金をいただいております。</p>
				</div>
			</div><!-- /.con_list -->
		</div><!-- /.wrp_list -->
