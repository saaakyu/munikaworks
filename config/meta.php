...
define('KEYWORDS', '創作,同人,デザイン,ロゴ,エンターテイメント,Vtuber,世界観');
define('DESCRIPTION', 'ムニカワークスでは「世界観引き出すデザインを。」をコンセプトに、創作・エンターテインメント分野を中心としたグラフィック・ロゴ・印刷物などのデザイン制作を承っております。');
define('H1', '創作・エンタメ分野のデザインはムニカワークス');
