...
//共通文言
define('TITLE', 'ムニカワークス');
define('KEYWORDS', '創作,同人,デザイン,ロゴ,同人,Vtuber,世界観');
define('DESCRIPTION', 'ムニカワークスでは「世界観引き出すデザインを。」をコンセプトに、同人・エンターテインメント分野を中心としたグラフィック・ロゴ・印刷物などのデザイン制作を承っております。');
define('H1', '同人・エンタメ分野のデザインはムニカワークス');
...
if ($page == 'about') {
	...
	$meta['description'] = 'ロゴデザインを中心に同人誌デザイン、Vtuber様のデザインなど、同人・エンターテインメント分野を中心としたデザイン制作をしています。お手伝いできることがございましたらぜひご相談ください。';
	$meta['h1'] = H1;
}
...
if ($page == 'service') {
	...
	$meta['description'] = 'ロゴデザインを中心に同人誌デザイン、Vtuber様のデザインなども承っております。その他、バナーやノベルティデザインなどもご対応が可能ですのでお気軽にお問い合わせください。';
	$meta['h1'] = H1;
}
