			...
			<div class="wrp_intro">
				<div class="con_intro">
					<div class="box_intro">
						...
						<p class="txt center">内容を確認し、3日以内にメールにてご連絡させていただきます。<br class="view_pc-tab">しばらく経ってもメールが届かない場合は直接contact@munika-works.comまでご連絡ください。</p>
						<p class="txt center">Xも随時更新しておりますので、この機会にぜひフォローをお願いいたします！</p>

						<div class="timeline">
							<a class="twitter-timeline" href="https://twitter.com/munikaworks?ref_src=twsrc%5Etfw">Tweets by munikaworks</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
						</div>
					</div>
				</div>
			</div><!-- /.wrp_intro -->
